...
if(isset($_GET['email']) && isset($_GET['code'])){
    ...
    $email = $_GET['email'];
    $code = $_GET['code'];
    $mail_body = 'As part of the Fernandez Dental Clinic account registration process, we’ll need to verify your details by clicking the link: <a href="'. pathUrl(). 'verify-email.php?email='. $email .'&code='. $code .'" target="_blank">'.'Verify My E-mail'.'</a>';    
