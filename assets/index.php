...
.bs-example{
    margin: 20px;
            ...
            <div class="col-md-4">
            <img src="assets/img/rodrigo.png" title='Dr. Rodrigo Fernandez' data-toggle="modal" data-target="#myModal1" style='height: 300px; cursor: pointer;'/> 
            </div>
            <div class="col-md-4">
            <img src="assets/img/mikee.jpg" title='Dr. Mikee Fernandez' data-toggle="modal" data-target="#myModal1" style='height:300px;cursor: pointer;margin-left: 10%;'/>
            </div>
            <div class="col-md-4">
            <img src="assets/img/susan.png" title='Dr. Susan Fernandez' data-toggle="modal" data-target="#myModal1" style='height:300px; cursor: pointer;'/>        
            </div>
            </div>
            ...
            <div class="container" id="SERVICES">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <img src="assets/img/Periodontics.jpg">
                            <h4>Periodontics</h4>
...
<div class="row">
    ...
    <div class="col-lg-2 col-md-2 col-xs-12 text-center" style="margin-left: -25%;">
