        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">Fernandez Dental Clinic<img alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#HOME"><strong>Home</a></strong></li>
                         <li><a href="#ABOUTUS"><strong>About Us</strong></a></li>
                          <li><a href="#SERVICES"><strong>Services</strong></a></li>
                           ...
                           <li>
                            <p class="navbar-text">Create an account?</p>
                        </li>
                        <li><a href="#" data-toggle="modal" data-target="#myModal"><strong>Sign Up</a></strong></li>
            ...
            <div class="container"  id="HOME">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>Doctor's Schedule. Please <span class="label label-danger">login</span> to make an appointment. </p>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container" id="ABOUTUS">
                <div class="underlined-title">
                    <h1>About Us</h1>
                    <hr>
                    <h2>Who we are? Read informations below</h2>
                </div>
                <div class="row">
...
<div class="service-bg">
            <div class="container" id="SERVICES">
                <div class="underlined-title">
                    ...
                    <hr>
                    <h2>We provide a better service here</h2>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2"> 
                        ...
                        <div class="col-xs-10">
                            ...
                            <button type="button" class="btn btn-sm btn-success">Read More</button>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
...
<div class="contact-bg">
    ...
    <p class="text-center w-responsive mx-auto mb-5"><strong>Do you have any questions? Please do not hesitate to contact us directly.We will come back to you within
...
<div class="row">
    <div class="col-md-10">
    <strong><input type="text" name="fname" class="form-control"placeholder="Enter Firstname" style="margin-left:35%;width:30%; " required=""></strong>
    <br>
    <strong><input type="text" name="lname" class="form-control" placeholder="Enter Lastname" style="margin-left:35%;width:30%; " required=""></strong>
    <br>
    <strong><input type="text" name="emailsend" class="form-control" placeholder="Enter Email Address" style="margin-left:35%;width:30%; " required=""></strong>
     <br>
    <strong><input type="text" name="cnumber" class="form-control" placeholder="Enter ContactNo" style="margin-left:35%;width:30%; " required=""></strong>
       <br>
    <strong><input type="text" name="subject" class="form-control" placeholder="Subject" style="margin-left:35%;width:30%; " required=""></strong>
     <br>
    <strong><textarea type="textarea" name="message" class="form-control" placeholder="Enter Message" style="margin-left:35%;width:30%; " required=""></textarea></strong>
    <br>
    <input type="submit" name="send" class="btn btn-sm btn-success" style="margin-left:35%;width:30%;">
    </div>
    <div class="col-md-2 text-center" style="margin-left: -25%;">
            <ul class="list-unstyled mb-0">
                ...
                <li><i class="fa fa-envelope mt-4 fa-2x"></i>
                    <strong><p>MikeeFernandez@gmail.com</p>
                    <p>SusanFernandez@gmail.com</p></strong>
                </li>
            </ul>
        </div>
...
<!--Contact Us Content-->
        ...
        <div class="copyright-bar">
            <div class="container">
                ...
                <p class="pull-right small"><a href="adminlogin.php"><strong>Log in as admin?</a></strong></p>
            </div>
        </div>
        <!-- footer end -->
    </div>
