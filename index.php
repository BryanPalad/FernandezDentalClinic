                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#HOME"><img src="assets/img/Home_16.png"><strong>Home</a></strong></li>
                         <li><a href="#ABOUTSLIDE"><img src="assets/img/About_16.png"><strong>About Us</strong></a></li>
                          <li><a href="#SERVICESLIDE"><img src="assets/img/Stethoscope_16.png"><strong>Services</strong></a></li>
                           <li><a href="#LOCATIONSLIDE"><img src="assets/img/Location_16.png"><strong>Location</strong></a></li>
                           <li><a href="#FAQSLIDE"><img src="assets/img/Faq_16.png"><strong>FAQ</strong></a></li>
                           <li><a href="#CONTACTSLIDE"><img src="assets/img/Phone_16.png"><strong>Contact Us</strong></a></li>
...
.mySlides {display:none;}
  ...
  <?php echo "<img class='mySlides' src='doctor/uploads/".$backgrounds['background']."' style='width:1400px;height:650px;margin-left:-180px;margin-top:-5px;'>"?>
 <?php echo "<img class='mySlides' src='doctor/uploads/".$backgrounds2['background']."' style='width:1400px;height:650px;margin-left:-180px;margin-top:-5px;'>"?>
  <?php echo "<img class='mySlides' src='doctor/uploads/".$backgrounds3['background']."' style='width:1400px;height:650px;margin-left:-180px;margin-top:-5px;'>"?>
</div>
...
function carousel() {
    ...
    setTimeout(carousel, 3000); // Change image every 3 seconds
        ...
        <section>
           <!--  <?php echo "<img src='doctor/uploads/".$backgrounds['background']."' style='height:630px;width:100%;background-size: cover;
                -moz-background-size: cover; 
                background-position: center;'>";
                                ?> -->
            <div class="container">
                <div class="row">
                    <div class="col-md-5" style="margin-top: -500px;">
                        <h2><?php echo$welcomes['title'];?></h2>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container" id="ABOUTSLIDE">
                <div class="underlined-title">
                    ...
                    <h2>Read Our Informations Below</h2>
                </div>
                <style type="text/css">
.carousel{
    background: #ffffff;
...
.bs-examples{
    margin: 20px;
            ...
            <?php
            $detail1 = mysqli_query($con,"SELECT * from aboutus where id='1'");
            $details1 = mysqli_fetch_array($detail1);
            $detail2 = mysqli_query($con,"SELECT * from aboutus where id='2'");
            $details2 = mysqli_fetch_array($detail2);
            $detail3 = mysqli_query($con,"SELECT * from aboutus where id='3'");
            $details3 = mysqli_fetch_array($detail3);
            ?>
            <style type="text/css">
                .about
                {
            ...
            <div class="col-md-4"> 
            <?php echo "<img src='doctor/uploads/".$details1['image']."' data-toggle='modal' data-target='#rodrigo' style='height:300px; cursor:pointer' title='Click for more info'>";
            ?>
            <!-- <br>
            <div class="about">
            <h5> Dr.Rodrigo Fernandez</h5>
            <h5>Specialties:</h5>
            ...
            <div class="col-md-4">
             <?php echo "<img src='doctor/uploads/".$details2['image']."' data-toggle='modal' data-target='#mikee' style='height:300px; cursor:pointer'title='Click for more info'>";
            ?>
            <!-- <div class="about">
            <h5> Dr.Mikee Fernandez</h5>
            <h5>Specialties:</h5>
            <h5>Preventive Pediatric</h5>
            <h5>Periodontics</h5>
            </div> -->
            </div>
            <div class="col-md-4">
             <?php echo "<img src='doctor/uploads/".$details3['image']."' data-toggle='modal' data-target='#susan' style='height:300px; cursor:pointer'title='Click for more info'>";
            ?>        
            <!-- <div class="about">
            <h5> Dr.Susan Fernandez</h5>
            <h5>Specialties:</h5>
            <h5>Orthodontics</h5>
            <h5>TMJ specialist</h5>
            </div> -->
            </div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" style="background: cover;">
            <div class="item active">
               <?php echo "<img src='doctor/uploads/".$sliders['slider']."' style='width: 100%;height: 300px;'>";
            ?>
            </div>
            <div class="item">
                <?php echo "<img src='doctor/uploads/".$sliders2['slider']."' style='width: 100%;height: 300px;'>";
            ?>
            </div>
            <div class="item">
                <?php echo "<img src='doctor/uploads/".$sliders3['slider']."' style='width: 100%;height: 300px;'>";
            ?>
            </div>
        </div>
...
<div class="service-bg">
    <?php echo "<img src='doctor/uploads/".$servicebackgrounds['background']."' style='height:1400px;width:100%;margin-bottom:-1460px;'>";?>
            <div class="container" id="SERVICESLIDE">
                <div class="underlined-title">
                    <br>
        ...
        <br>
            ...
            <div class="container" id="LOCATIONSLIDE">
...
<?php 
$faq = mysqli_query($con,"SELECT * from faq where status ='approved'");
?>
<div class="container" id="FAQSLIDE">

                <div class="underlined-title">
                    <h1>Frequently Asked Questions</h1>
                    <strong><h2>Ask questions and we will answer as soon as possible</h2></strong>
                </div>
         
                <div class="col-md-12" style="text-align: center;">
                    <?php while($faq_rows=mysqli_fetch_array($faq)):
                    ?>
                <ul>
                   <li class="q"><?=$faq_rows['question'];?></li>
                   <li class="a"><?=$faq_rows['answer'];?></li>   
                </ul>
                    ...
                    <div class="container-fluid">
                    <div class="col-md-12">
                        <form method="POST" onsubmit="return confirm('Are you sure you want to submit this question?');">
                        <textarea name="faquestion" rows="3" class="form-control input-lg" placeholder="Free to ask questions, Just type here" required="" ></textarea> 
                        <input type="submit" value="Submit Question"name="submitfaq" class="btn btn-primary">
                    </div>
                </div>
<br>
</div>
    ...
    if(isset($_POST['submitfaq']))
    {
        ...
        $submit = $_POST['faquestion'];
        mysqli_query($con,"INSERT into faq (id,question,answer,status,faqdate) values (default,'$submit','null',default,'$now')");  
        ?>
        <script type="text/javascript">
          alert("Your question is submitted, Kindly wait for the admins response..");
        </script>
        ?>
        <?php
    }
...
<div class="contact-bg">
    <!--Section heading-->
    <?php echo "<img src='doctor/uploads/".$contactus['background']."' style='height:480px;width:100%;margin-bottom:-510px;'>";?>
    <h2 class="h1-responsive font-weight-bold text-center my-5" id="CONTACTSLIDE">CONTACT US</h2>

    <p class="text-center w-responsive mx-auto mb-5"><strong><?php echo$contactus['title']?></p></strong>
<br>
<?php
$contactbackground = mysqli_query($con,"SELECT * from contactuscontent");
$contactbackgrounds = mysqli_fetch_array($contactbackground);

$cb = $contactbackgrounds['background'];
?>
<!-- <style>
    .contact-bg
    {   
        background-image: url("doctor/uploads/".$cb."");
        background-repeat: no-repeat;
        background-size: cover;
    }
</style>
...
<div class="row">
    ...
    <?php 
    $sql1 = mysqli_query($con,"SELECT * from contactusnumber where id ='1'");
    $sqls1 = mysqli_fetch_array($sql1);
    $sql2 = mysqli_query($con,"SELECT * from contactusnumber where id ='2'");
    $sqls2 = mysqli_fetch_array($sql2);
    $sql3 = mysqli_query($con,"SELECT * from contactusnumber where id ='3'");
    $sqls3 = mysqli_fetch_array($sql3);

    $email = mysqli_query($con,"SELECT * from contactusemail");
    $emails = mysqli_fetch_array($email);
    ?>
    <div class="col-xs-12 text-center">
            <ul class="list-unstyled mb-0">
                <li><i class="fa fa-map-marker fa-2x"></i>
                    <strong><p><?php echo$contactusadds['address']?></p></strong>
                </li>

                <li><i class="fa fa-phone mt-4 fa-2x"></i>
                    <strong><p><?php echo$sqls1['phone'];?></p></strong>
                    <strong><p><?php echo$sqls2['phone'];?></p></strong>
                    <strong><p><?php echo$sqls3['phone'];?></p></strong>
                </li>

                <li><i class="fa fa-envelope mt-4 fa-2x"></i>
                    <strong><p><?php echo$emails['email']?></p>
                    </strong>
                </li>
                <br>
            </ul>
...
<div class="modal fade" id="rodrigo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                ...
                                <h3 class="modal-title" style="text-align: center;">Dentist Information</h3>
                            ...
                            <div class="modal-body" style="font-family: Times New Roman; font-size: 20px;">
                                ...
                                <?php echo$details1['descriptions'];?>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="modal fade" id="mikee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                           <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <!-- modal content -->
                            <div class="modal-header">
                            ...
                            <div class="modal-body" style="font-family: Times New Roman; font-size: 20px;">
                                ...
                                <?php echo$details2['descriptions'];?>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="modal fade" id="susan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                           <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <!-- modal content -->
                            <div class="modal-header">
                            ...
                            <div class="modal-body" style="font-family: Times New Roman; font-size: 20px;">
                                ...
                                <?php echo$details3['descriptions'];?>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  <!-- Modal for Prosthodontics-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h3 class="modal-title" style="text-align: center;"><?php echo $services['service'];?></h3><h4 style="text-align: center;">Offered By: <?php echo $services['offered_by'];?></h4>
                            ...
                            <div class="modal-body">
                                ...
                                $res = mysqli_query($con,"SELECT * from service where service_type ='$serve'");
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h3 class="modal-title" style="text-align: center;"><?php echo $services2['service'];?></h3><h4 style="text-align: center;">Offered By: <?php echo $services2['offered_by'];?></h4>
                            </div>
                            <!-- modal body start -->
                            <?php 
                            $serve2 = $services2['service'];
                            ?>
                            <div class="modal-body">
                                <br>
                                <?php
                                ...
                                $res = mysqli_query($con,"SELECT * from service where service_type ='$serve2'");
                                while ($service = mysqli_fetch_array($res))
                                {
                                echo "<tbody>";
                                echo "<tr>";
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h3 class="modal-title" style="text-align: center;"><?php echo $services3['service'];?></h3><h4 style="text-align: center;">Offered By: <?php echo $services3['offered_by'];?></h4>
                            </div>
                            <!-- modal body start -->
                            <?php 
                            $serve3 = $services3['service'];?>
                            <div class="modal-body">
                                <br>
                                <?php
                                echo "<table class='table table-hover'>";
                                ...
                                $res = mysqli_query($con,"SELECT * from service where service_type ='$serve3'");
                                while ($service = mysqli_fetch_array($res))
                                {
                                echo "<tbody>";
                                echo "<tr>";
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h3 class="modal-title" style="text-align: center;"><?php echo $services4['service'];?></h3><h4 style="text-align: center;">Offered By: <?php echo $services4['offered_by'];?></h4>
                            </div>
                            <!-- modal body start -->
                            <?php 
                            $serve4 = $services4['service'];?>
                            <div class="modal-body">
                                <br>
                                <?php
                                echo "<table class='table table-hover'>";
                                ...
                                $res = mysqli_query($con,"SELECT * from service where service_type ='$serve4'");
                                while ($service = mysqli_fetch_array($res))
                                {
                                echo "<tbody>";
                                echo "<tr>";
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h3 class="modal-title" style="text-align: center;"><?php echo $services5['service'];?></h3><h4 style="text-align: center;">Offered By: <?php echo $services5['offered_by'];?></h4>
                            </div>
                            <!-- modal body start -->
                            
                            <?php 
                            $serve5 = $services5['service'];?>
                            <div class="modal-body">
                                <br>
                                <?php
                                echo "<table class='table table-hover'>";
                                ...
                                $res = mysqli_query($con,"SELECT * from service where service_type ='$serve5'");
                                while ($service = mysqli_fetch_array($res))
                                {
                                echo "<tbody>";
                                echo "<tr>";
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h3 class="modal-title" style="text-align: center;"><?php echo $services6['service'];?></h3><h4 style="text-align: center;">Offered By: <?php echo $services6['offered_by'];?></h4>
                            </div>
                            <!-- modal body start -->
                            <?php 
                            $serve6 = $services6['service'];?>
                            <div class="modal-body">
                                <br>
                                <?php
                                echo "<table class='table table-hover'>";
                                ...
                                $res = mysqli_query($con,"SELECT * from service where service_type ='$serve6'");
                                while ($service = mysqli_fetch_array($res))
                                {
                                echo "<tbody>";
                                echo "<tr>";
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h3 class="modal-title" style="text-align: center;"><?php echo $services7['service'];?></h3><h4 style="text-align: center;">Offered By: <?php echo $services7['offered_by'];?></h4>
                            </div>
                            <!-- modal body start -->
                            <?php 
                            $serve7 = $services7['service'];?>
                            <div class="modal-body">
                                <br>
                                <?php
                                echo "<table class='table table-hover'>";
                                ...
                                $res = mysqli_query($con,"SELECT * from service where service_type ='$serve7'");
                                while ($service = mysqli_fetch_array($res))
                                {
                                echo "<tbody>";
                                echo "<tr>";
...
<div class="modal fade" id="terms" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="font-family: Times New Roman; font-size: 20px;text-align: justify;">
                ...
                <div class="modal fade" id="missionvision" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                           <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <!-- modal content -->
                            <div class="modal-header">
                            ...
                            <div class="modal-body" style="font-family: Times New Roman; font-size: 20px;text-align: justify;">
                                <h3 style="text-align: center; margin-top: -20px;">Mission</h3>
                                <?php echo$vision['mission'];?>
                                <br>
                               <h3 style="text-align: center;">Vision</h3>
                                <?php echo$vision['vision'];?>
                                <br>
                            </div>
                        </div>
                    </div>
...
<div class="copyright-bar" >
    <div class="container">
        ...
        <p class="pull-right small"><a data-toggle='modal' data-target='#missionvision' style="cursor: pointer;"><strong> Mission & Vision </strong></a><a data-toggle='modal' data-target='#terms' style="cursor: pointer;"><strong> Terms and Conditions </strong></a><a href="testimonials.php"><strong> Testimonials </strong></a><a data-toggle='modal' data-target='#privacy' style="cursor: pointer;"><strong> Privacy Policy </strong></a><a href="adminlogin.php"><strong> Log in as Doctor? </strong></a></p>
    </div>
</div>
    <!-- date end -->
