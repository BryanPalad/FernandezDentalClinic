...
if(isset($_POST['modify']))
{
    ...
    ?>
    <script type="text/javascript">
        alert('Successfully followed up a schedule');
    </script>
    <?php
    header("Location: patientlist.php");
}
                            ...
                            <div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <textarea name="medication" style="width:250px; height:80px;"><?php echo $userRow['medication'];?></textarea>                 
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <label> Diagnosis:</label>
                                    <div class="input-group">
                                        <textarea name="diagnosis" style="width:250px; height:80px;"><?php echo $userRow['diagnosis'];?></textarea>                 
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <label> Prognosis:</label>
                                    <div class="input-group">
                                        <textarea name="prognosis" style="width:250px; height:80px;"><?php echo $userRow['prognosis'];?></textarea>                 
                                    </div>
                                </div>
                                <script>
                                    function getTime(){
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group" style="margin-bottom:10px;">
                                        ...
                                        <input class="form-control" id="startDate" onchange="getTime()" name="startDate" value="<?php echo date("Y-m-d")?>"/>
                                    </div>
                                    </div>
                                    <div class="col-md-10">
                                ...
                                <div class="row">
                                    <br>
                                    <div class="col-md-12">
                                        <input type="submit" onclick="return confirm('Are you sure you want to update this record');" name="complete"
                                        id="submit" class="btn btn-primary" value="Update Record">
