...
<head>
	...
	<a class="navbar-brand" style="height: 60px; color: darkblue;">Fernandez Dental Clinic<img alt=""></a>
	</div>
						...
						<form class="form" role="form" method="POST" accept-charset="UTF-8">
							...
							<div class="row">
								...
								?>
									...
									<select name="starttime" class="form-control input-lg" required>
										...
										<?php
											...
											$statement = "select * from schedule where doctorId = $docId and scheduleDate = '$scheduleDate' and status ='pending'";
								...
								<div class="form-group col-md-12">
									<label for="message-text" class="control-label">Complain/s:</label>
	...
	$msg = "Hi"." ".$pname."! "." You have scheduled your appointment on"." ".$appdate." at ".date("h:i A", strtotime($starttime)).", Please go to the clinic 30 minutes before your appointment Thankyou!.";
	$text = "From: ".$name." 
	".$msg;
	...
	$msgs = "Hello"." "."Dr. ".$dname."!"
	." ".$fname." ".$lname." "."made an appointment on"." ".$appdate." at ".date("h:i A", strtotime($starttime));
