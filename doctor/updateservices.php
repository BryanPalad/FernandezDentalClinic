...
$service_row = mysqli_fetch_array($res,MYSQLI_ASSOC);
?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            Edit Service
                             ...
                             <form action="services.php" method="POST" onsubmit="return('Are you sure you want to edit this service?');">
                                <input type="hidden" name="id" value="<?php echo $service_row['service_id'];?>">
                            <h4>Service Name:</h4>
                            <input type="text" name="servicename" value="<?php echo $service_row['service_name'];?>"class="form-control input-lg" style="width: 50%;" required="">
                            <br>
                            <h4>Service Type:</h4>
                           <select name="servicetype" class="form-control input-lg" required="" style="width: 50%;">
                               <option><?php echo $service_row['service_type'];?></option> 
                            ...
                            <br>
                            <h4>Service Estimated Time:</h4>
                           <select name="servicetime" class="form-control input-lg" style="width: 50%;" required="">
                             <option value="<?php echo $service_row['service_time'];?>"><?php echo $service_row['service_time'];?> minutes</option> 
