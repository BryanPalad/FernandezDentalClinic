...
$doctorfname = mysqli_real_escape_string($con,$_POST['doctorfname']);
$doctorlname = mysqli_real_escape_string($con,$_POST['doctorlname']);
$doctorId = mysqli_real_escape_string($con,$userRow['doctorid']);

$docn = mysqli_real_escape_string($con,$userRow['doctorFirstName']);

$sql = "SELECT * from doctorschedule where scheduleDate = '$date' and doctorFirstName = '$docn'";
...

{
  ?>
  <script>
    window.alert('You have already scheduled on this Date, Please select another date..');
  </script>
  <?php
...
else if($date < date('Y-m-d'))
{
  ?>
  <script>
  window.alert('Date is passed, You cant schedule on that day');
  </script>
  <?php
...
else if($date == date('Y-m-d'))
{
  ...
  ?>
  <script>
  window.alert('Adding schedule today is invalid. Please select advance date.');
  </script>
  <?php
...
//INSERT
$query = " INSERT INTO doctorschedule(  scheduleDate, startTime, endTime,  bookAvail, doctorFirstName, doctorLastName, doctorId)
VALUES ( '$date', '$starttime', '$endtime', '$bookavail', '$doctorfname', '$doctorlname','$doctorId' ) ";
...
<html lang="en">
    <head>
        ...
        <link href="assets/js/bootstrap-datepicker.js" rel="stylesheet">
                ...
                <div class="container-fluid">
                               ...
                               <div class="col-md-12 col-sm-12 col-xs-12">
                                <form class="form-horizontal" method="post">
                                 <div class="form-group form-group-lg">
                                  <input type="hidden" name ="doctorfname"value="<?php echo $userRow['doctorFirstName'];?>">
                                  <input type="hidden" name ="doctorlname"value=" <?php echo $userRow['doctorLastName'];?>">
                                  <input type="hidden" name ="doctorId"value=" <?php echo $userRow['doctorid'];?>">
                                  ...
                                  <div class="col-sm-10">
                                   <div class="input-group">
                                    ...
                                    <input  name="date" type="date" class="form-control" id="date"  value="<?php echo date("Y-m-d")?>" required/>
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            $result=mysqli_query($con,"SELECT * FROM doctorschedule where doctorFirstName = '$doc' ORDER by scheduleDate desc");
                                ...
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $doctorschedule['doctorFirstName'] ." ". $doctorschedule['doctorLastName'] ."</td>";
                                    echo "<td>" . $doctorschedule['scheduleDate'] . "</td>";
                                    echo "<td>" . date("h:i A", strtotime($doctorschedule['startTime'])) . "</td>";
                                    echo "<td>" . date("h:i A", strtotime($doctorschedule['endTime'])) . "</td>";
                                    echo "<td>" . $doctorschedule['bookAvail'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='updateschedule.php?scheduleId=".$doctorschedule['scheduleId']."' class='update'><img src='assets/img/edit_16.png' aria-hidden='true'></a>
                            </td>";
                                    echo "<td class='text-center'><a href='#' id='".$doctorschedule['scheduleId']."' class='delete'><img src='assets/img/trash_16.png' aria-hidden='true'></a>
                            </td>";
